...
export async function uploadAssetAction(formData: FormData): Promise<void> {
  ...
  revalidatePath('/emails/beithady/gallery');
  if (building) revalidatePath(`/emails/beithady/gallery/${building}`);
  if (listingId) revalidatePath(`/emails/beithady/gallery/${building}/${listingId}`);
}
...
export async function deleteAssetAction(formData: FormData): Promise<void> {
  ...
  revalidatePath('/emails/beithady/gallery');
  if (a.building_code) revalidatePath(`/emails/beithady/gallery/${a.building_code}`);
}
