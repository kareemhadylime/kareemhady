...
export default async function BrandLibraryPage({
  ...
  return (
    <BeithadyShell breadcrumbs={[
      ...
      {asset && <AssetDetailModal asset={asset} closeHref="/emails/beithady/gallery/brand-library" />}
      ...
      <AssetGrid assets={list.rows} detailHrefBase="/emails/beithady/gallery/brand-library?" />
    </BeithadyShell>
  );
}
