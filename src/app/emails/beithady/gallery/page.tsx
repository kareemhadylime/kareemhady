...
import { Image as ImageIcon, FileText, Megaphone, Building2, ChevronRight, Sparkles } from 'lucide-react';
...
export default async function GalleryLandingPage({
  ...
  return (
    <BeithadyShell breadcrumbs={[{ label: 'Gallery' }]} containerClass="max-w-7xl">
      ...
      {asset && (
        <AssetDetailModal asset={asset} closeHref="/emails/beithady/gallery" />
      )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {(['BH-26','BH-73','BH-435','BH-OK','BH-34'] as const).map(code => {
            ...
            return (
              <Link
                key={code}
                href={`/emails/beithady/gallery/${code}`}
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <Link href="/emails/beithady/gallery/documents" className="ix-card p-5 block hover:shadow-md transition">
        ...
        <Link href="/emails/beithady/gallery/brand-library" className="ix-card p-5 block hover:shadow-md transition">
        ...
        <Link href="/emails/beithady/gallery/ad-creatives" className="ix-card p-5 block hover:shadow-md transition">
