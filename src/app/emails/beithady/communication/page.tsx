    ...
    <BeithadyShell breadcrumbs={[{ label: 'Communication' }]}>
      ...
      {paused && (
        <div className="ix-card p-4 border-rose-200 dark:border-rose-800 bg-rose-50/50 dark:bg-rose-950/30 flex items-start gap-3">
          ...
          <div className="space-y-1">
            ...
            <Link href="/emails/beithady/settings/templates" className="ix-link text-xs font-semibold">
      ...
      <section className="space-y-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
          <ChannelCard
            href="/emails/beithady/communication/guesty"
            icon={<Inbox size={20} />}
            title="Guesty Inbox"
          ...
          />
          <ChannelCard
            href="/emails/beithady/communication/wa-casual"
          ...
          />
          <ChannelCard
            href="/emails/beithady/communication/wa-cloud"
            icon={<Phone size={20} />}
          ...
          />
          <ChannelCard
            href="/emails/beithady/communication/unified"
            icon={<Layers size={20} />}
            title="Unified inbox"
