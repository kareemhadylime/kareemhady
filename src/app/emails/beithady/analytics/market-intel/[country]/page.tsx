...
export default async function CountryDrillPage({ params }: { params: Promise<{ country: string }> }) {
  ...
  return (
    <BeithadyShell breadcrumbs={[
      ...
      { label: 'Market Intelligence', href: '/emails/beithady/analytics/market-intel' },
      { label: countryName(c) },
      ...
      <BeithadyHeader
        ...
        right={
          <Link href="/emails/beithady/analytics/market-intel" className="ix-btn-secondary text-xs">
      ...
      <section className="ix-card p-4 space-y-2">
        ...
        <ul className="text-sm space-y-1 text-slate-600 dark:text-slate-300 list-disc pl-5">
          ...
          <li>
            <Link href={`/emails/beithady/crm?country=${c}`} className="ix-link">
