  ...
  return (
    <BeithadyShell breadcrumbs={[{ label: 'Inventory' }]} containerClass="max-w-7xl">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <InvCard
          href="/emails/beithady/inventory/dashboard"
        ...
        />
        <InvCard
          href="/emails/beithady/inventory/warehouses"
          icon={Warehouse}
          title="Warehouses"
        ...
        />
        <InvCard
          href="/emails/beithady/inventory/items"
          icon={Boxes}
          title="Items / Catalog"
        ...
        />
        <InvCard
          href="/emails/beithady/inventory/vendors"
          icon={Building2}
        ...
        />
        <InvCard
          href="/emails/beithady/inventory/stock"
          icon={PackageSearch}
          title="Stock"
        ...
        />
        <InvCard
          href="/emails/beithady/inventory/grn"
          icon={PackagePlus}
          title="Receiving (GRN)"
        ...
        />
        <InvCard
          href="/emails/beithady/inventory/issue"
          icon={PackageMinus}
        ...
        />
        <InvCard
          href="/emails/beithady/inventory/transfers"
          icon={ArrowLeftRight}
          title="Transfers"
        ...
        />
        <InvCard
          href="/emails/beithady/inventory/counts"
          icon={ClipboardCheck}
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
        <QuickLink
          href="/emails/beithady/inventory/approvals"
          icon={ShieldCheck}
        ...
        />
        <QuickLink
          href="/emails/beithady/inventory/rules"
          icon={ScrollText}
        ...
        />
        <QuickLink
          href="/emails/beithady/inventory/m"
          icon={Smartphone}
