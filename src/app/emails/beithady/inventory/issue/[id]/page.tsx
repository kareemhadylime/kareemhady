  ...
  return (
    <BeithadyShell
      breadcrumbs={[
        ...
        { label: 'Dispensing (Issue)', href: '/emails/beithady/inventory/issue' },
    ...
    >
      ...
      <Link href="/emails/beithady/inventory/issue" className="text-xs text-cyan-700 hover:underline inline-flex items-center gap-1">
