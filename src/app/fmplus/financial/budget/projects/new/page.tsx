    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <header>
        <Link href="/fmplus/financial/budget/projects"
          className="text-xs text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-100 inline-flex items-center gap-1 mb-3">
          <ArrowLeft size={12} /> Back to Project Hub
        </Link>
        <h2 className="text-base font-semibold text-slate-900 dark:text-slate-100">+ New Contract</h2>
      ...
      <form action={createContractAction} className="space-y-5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg p-5">
        {/* 1. Odoo analytic account */}
        <fieldset className="space-y-2">
          <legend className="text-xs uppercase font-semibold text-slate-500 dark:text-slate-400">1. Odoo project (analytic account)</legend>
          <select name="project_id" required defaultValue=""
            className="w-full text-sm bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded px-2 py-1.5">
        ...
        <fieldset className="space-y-2">
          <legend className="text-xs uppercase font-semibold text-slate-500 dark:text-slate-400">2. Contract metadata</legend>

          <label className="block">
            <span className="text-xs text-slate-500 dark:text-slate-400">Contract name <span className="text-red-400">*</span></span>
          ...
          <div className="grid grid-cols-2 gap-3">
            <label className="block">
              <span className="text-xs text-slate-500 dark:text-slate-400">Start date <span className="text-red-400">*</span></span>
              <input name="start_date" type="date" required
                className="w-full text-sm bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded px-2 py-1.5 mt-1" />
            </label>
            <label className="block">
              <span className="text-xs text-slate-500 dark:text-slate-400">End date <span className="text-red-400">*</span></span>
          ...
          <div className="grid grid-cols-2 gap-3">
            <label className="block">
              <span className="text-xs text-slate-500 dark:text-slate-400">Contract value (EGP)</span>
        ...
        <fieldset className="space-y-2">
          <legend className="text-xs uppercase font-semibold text-slate-500 dark:text-slate-400">3. Year tracking + zones</legend>
          ...
          <label className="block mt-2">
            <span className="text-xs text-slate-500 dark:text-slate-400">Zones (comma-separated, optional)</span>
            <input name="zones" placeholder="e.g. Zone A, Zone B"
              className="w-full text-sm bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded px-2 py-1.5 mt-1" />
            <span className="text-[10px] text-slate-500 dark:text-slate-400">Reference only — budget lines aggregate to project total per spec § 4 Q5.</span>
          </label>
        </fieldset>

        {/* 4. Service lines */}
        <fieldset className="space-y-2">
          <legend className="text-xs uppercase font-semibold text-slate-500 dark:text-slate-400">4. Service lines <span className="text-red-400">*</span></legend>
