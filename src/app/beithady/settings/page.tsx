...
const SUBTABS: Subtab[] = [
  ...
  },
  {
    slug: 'branding',
    tile: {
      href: '/beithady/settings/branding',
      title: 'Branding',
  ...
  },
  {
    slug: 'custom-fields',
    tile: {
      href: '/beithady/settings/custom-fields',
      title: 'Custom fields',
