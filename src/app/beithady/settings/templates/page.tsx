    ...
    <BeithadyShell breadcrumbs={[
      ...
      <section className="ix-card p-5 space-y-2">
        ...
        <ul className="text-xs space-y-1 ml-4 list-disc text-slate-700 dark:text-slate-200">
          ...
          <li>AI auto-reply suggestions on incoming guest messages — controlled at <Link href="/beithady/settings/ai-config" className="ix-link">AI configuration</Link>.</li>
        </ul>
      </section>
    </BeithadyShell>
  );
