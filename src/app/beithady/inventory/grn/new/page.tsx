    ...
    >
      ...
      {vendors.length === 0 ? (
        <div className="ix-card p-10 text-center text-sm text-slate-500">
          ...
          <p className="text-[11px] mt-2">Visit <a href="/beithady/inventory/vendors" className="text-cyan-700 underline">Vendors</a> to register one.</p>
        </div>
      ) : items.length === 0 ? (
        <div className="ix-card p-10 text-center text-sm text-slate-500">
          <p>No active items yet.</p>
          <p className="text-[11px] mt-2">Visit <a href="/beithady/inventory/items" className="text-cyan-700 underline">Items</a> to add some (manual or Excel import).</p>
        </div>
      ) : (
        <GrnDraftForm
