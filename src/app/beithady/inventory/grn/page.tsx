    ...
    >
      ...
      <section className="flex items-center justify-between gap-3 flex-wrap">
        <form action="" method="get" className="flex items-center gap-2 flex-wrap">
          ...
          {(sp.search || sp.status) && (
            <Link href="/beithady/inventory/grn" className="text-[11px] text-slate-500 hover:text-slate-700">Clear</Link>
          )}
        </form>
        {canWrite && (
          <Link
            href="/beithady/inventory/grn/new"
                ...
                {grns.map(g => (
                  <tr key={g.id} className="border-t border-slate-100 hover:bg-slate-50 cursor-pointer">
                    <td className="px-3 py-2 font-mono text-[11px]">
                      <Link href={`/beithady/inventory/grn/${g.id}`} className="hover:text-cyan-700 hover:underline">
                        {g.grn_no}
                      </Link>
                    </td>
                    ...
                    <td className="px-3 py-2 text-right">
                      <Link href={`/beithady/inventory/grn/${g.id}`} className="text-cyan-700 hover:text-cyan-900 inline-flex items-center gap-0.5 text-[11px]">
