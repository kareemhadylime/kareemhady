    ...
    <BeithadyShell breadcrumbs={[{ label: 'CRM' }]}>
      ...
      <form className="ix-card p-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3">
        ...
        <div className="flex gap-2 lg:col-span-4">
          ...
          <Link href="/beithady/crm" className="ix-btn-secondary">
            Clear
          </Link>
          <Link href="/beithady/crm/segments" className="ix-btn-secondary">
            <ListChecks size={14} /> Segments
          </Link>
          <Link href="/beithady/crm/loyalty" className="ix-btn-secondary">
            🥇 Loyalty
          </Link>
          <Link href="/beithady/crm/pipeline" className="ix-btn-secondary">
            📋 Pipeline
          </Link>
          <Link href="/beithady/crm/tasks" className="ix-btn-secondary">
            ✓ Tasks
          </Link>
        </div>
      </form>
            ...
            {list.rows.map(g => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-2 px-3">
                    <Link href={`/beithady/crm/${g.id}`} className="ix-link text-xs inline-flex items-center gap-1">
                      Open
