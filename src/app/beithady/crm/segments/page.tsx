            ...
            {segments.map(s => (
              <tr key={s.id} className="border-b border-slate-100 dark:border-slate-800">
                <td className="py-2 px-3">
                  <Link href={`/beithady/crm/segments/${s.id}`} className="font-medium hover:underline" style={{ color: 'var(--bh-navy)' }}>
                    {s.name}
                  </Link>
                  {s.description && (
                ...
                <td className="py-2 px-3 text-right">
                  <Link href={`/beithady/crm/segments/${s.id}`} className="ix-link text-xs inline-flex items-center gap-1">
