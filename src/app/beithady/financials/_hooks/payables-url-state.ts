// Pure URL-state helpers for the Payables page. See perf-pnl-url-state.ts
...
export const PAYABLES_BASE_PATH = '/beithady/financials/payables';
...
export function makePayablesDefaults(): FinPayablesUrlState {
