...
export function CellDrillThroughModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-stretch justify-end" onClick={onClose}>
      ...
      >
        <header className="sticky top-0 bg-[var(--bh-ink)] text-white px-5 py-4 flex items-start justify-between">
          <div>
        ...
        <main className="p-5 space-y-5">
          <section>
            ...
            <div className="text-3xl font-bold text-[var(--bh-ink)] dark:text-amber-100 tabular-nums">
          ...
          {listing && (
            <section className="pt-4 border-t border-slate-200 dark:border-slate-700">
              <a
                ...
                className="inline-flex items-center gap-1.5 text-sm font-semibold text-[var(--bh-ink)] dark:text-amber-100 hover:underline"
              >
