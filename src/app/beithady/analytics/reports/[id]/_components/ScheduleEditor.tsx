    ...
    <div className="ix-card p-5 space-y-3">
      ...
      {schedules.map(s => (
        ...
        >
          <div className="flex-1 text-sm">
            <span className="font-semibold capitalize text-[var(--bh-ink)] dark:text-amber-100">
              {s.frequency}
            </span>
      ...
      {canEdit && !adding ? (
        <button
          ...
          className="inline-flex items-center gap-1 text-xs font-semibold text-[var(--bh-ink)] hover:underline"
        >
