...
const PALETTE = ['#1e3a5f', '#c9a96e', '#15803d', '#b45309', '#7c3aed'];
      ...
      {metrics.map(m => {
        ...
        return (
          ...
          >
            ...
            <div className="text-xl font-bold text-[#1e3a5f] dark:text-amber-100 tabular-nums">
              {cell?.formatted || '—'}
            </div>
            {delta != null ? (
              <div
