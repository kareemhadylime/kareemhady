                ...
                <tr key={l.lead_id} className="border-b border-slate-100 dark:border-slate-800 align-middle">
                  ...
                  <td className="py-2 px-4">
                    ...
                    <div className="text-[10px] text-slate-500 inline-flex items-center gap-2">
                      ...
                      {l.beithady_guest_id && (
                        <Link href={`/beithady/crm/${l.beithady_guest_id}`} className="ix-link inline-flex items-center gap-1">
                  ...
                  <td className="py-2 px-4 text-[11px]">
                    {l.campaign_id ? (
                      <Link href={`/beithady/ads/campaigns/${l.campaign_id}`} className="ix-link">{l.campaign_name || `#${l.campaign_id}`}</Link>
                    ) : '—'}
                  </td>
