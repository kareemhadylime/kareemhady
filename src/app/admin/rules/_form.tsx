      ...
      <fieldset className="ix-card p-5 space-y-4">
        ...
        <Field label="Type">
          ...
          >
            ...
            <option value="beithady_requests_aggregate">Beithady guest requests aggregate (Airbnb)</option>
          </select>
        </Field>
        <Field
          label="Currency"
          hint="EGP for KIKA · USD for Beithady bookings · AED is hardcoded for Beithady payouts · ignored for Beithady reviews."
        >
          <input
            name="currency"
