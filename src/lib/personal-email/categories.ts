...
export const CATEGORIES: CategoryDef[] = [
  ...
  { slug: 'lime',                displayName: 'Lime',             description: 'Lime Investments corporate mail — HQ, holding-level, group ops.',      tier: 2, sortOrder: 22, gmailLabelName: 'Lime/Corporate',     accentColor: 'lime',    iconName: 'Building2' },
  ...
  { slug: 'subsidiary_voltauto', displayName: 'VoltAuto',         description: 'VoltAuto / EV / 懂车帝 / electric mobility subsidiary mail.',           tier: 2, sortOrder: 28, gmailLabelName: 'Lime/VoltAuto',      accentColor: 'yellow',  iconName: 'Zap' },
  ...
  { slug: 'technology',      displayName: 'Technology',           description: 'Tech vendors — GoDaddy, Vercel, Supabase, OpenAI, Anthropic, Cloudflare.', tier: 3, sortOrder: 15, gmailLabelName: 'Lime/Technology',    accentColor: 'cyan',    iconName: 'Cpu' },
  { slug: 'notifications',   displayName: 'Notifications / FYI',  description: 'Automated FYI from services — calendar reminders, CI noise.',         tier: 3, sortOrder: 20, gmailLabelName: 'Lime/Notifications', accentColor: 'slate',   iconName: 'Bell' },
  ...
  { slug: 'unassigned',      displayName: 'Unassigned',           description: 'Catch-all bucket — emails the rule + AI pipeline could not confidently sort.', tier: 3, sortOrder: 30, gmailLabelName: 'Lime/Unassigned',    accentColor: 'slate',   iconName: 'HelpCircle' },
