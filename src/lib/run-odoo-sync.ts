...
// Beithady finance scope for Phase 7.1:
//   4  = A1HOSPITALITY (owner of BH-435; Lime 50% stake)
//   5  = Beithady Hospitality - (EGYPT)
//   10 = Beithady Hospitality FZCO - (Dubai)
// Rationale: see memory file beithady_ownership_structure.md — per-building
// P&L needs owner-side + PM-side books, so A1HOSPITALITY is included
// alongside the two Beithady companies.
